...
def var_est(file_name):
    ...
    try:
        ...
        '''
        right now there is no need for the mask since we are working with spectra that don't even have bad pixels
        '''
...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename='/mnt/gastro/sarel/sdss/no_smooth/dev_est_mask_20.log', level=logging.INFO,
                        format='%(levelname)s: %(message)s')
    writer = csv.writer(open('/mnt/gastro/sarel/sdss/no_smooth/dev_est_mask_20.csv', 'w'))
    ...
    del dir_list[0]
    '''
    going back to estimate good files versus bad ones
    '''
    # file_list = []
    # with open('/mnt/gastro/sarel/sdss/no_smooth/dev_est_mask_good.csv') as csvfile:
